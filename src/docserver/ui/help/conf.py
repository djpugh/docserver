...
# -*- coding: utf-8 -*-
#
# docserver documentation build configuration file, created by
...
latex_documents = [
  ('latex', 'docserver.tex', u'docserver Project',
...
man_pages = [
    ('man', 'docserver', u'docserver Project',
     [__author__], 1)
]
...
texinfo_documents = [
  ('index', 'docserver', u'docserver Project',
   __author__, 'docserver', 'docserver Project',
   'Miscellaneous'),
]
