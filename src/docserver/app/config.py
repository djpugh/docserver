...
class AppConfigClass:
    ...
    package_url_slug = os.getenv('DOCSERVER_PACKAGE_URL_SLUG', '/packages')
    ...
    key = os.getenv('DOCSERVER_UPLOAD_KEY', str(uuid.uuid4()))
    salt = os.getenv('DOCSERVER_UPLOAD_SALT', str(uuid.uuid4()))
    secret = os.getenv('DOCSERVER_SECRET', str(uuid.uuid4()))
